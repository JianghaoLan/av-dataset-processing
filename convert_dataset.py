...
def convert_video_to_images(src_video_path, dst_dir, resize=None):
...
def convert_one(data_path, to_path, cp_rois_and_lms=False, resize=None):
    ...
    convert_video_to_images(video_path, to_path, resize)
...
def convert_dataset(dataset_root, output_root, data_list_path, cp_rois_and_lms=False, max_workers=8, resize=None):
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=max_workers) as executor:
        ...
        for id, vid, data_path in src_datas:
            ...
            f = executor.submit(convert_one, data_path, dst_dir, cp_rois_and_lms, resize)
...
def main():
    ...
    convert_dataset(dataset_root, output_root, data_list_path, cp_rois_and_lms, max_workers=max_workers, resize=resize)
